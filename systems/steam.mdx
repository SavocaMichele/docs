...
To install a game, you will need to know the AppID of the game you want to install. You can find the AppID by searching for the game on the [Steam Store](https://store.steampowered.com/). Once you have the AppID, these steps:
